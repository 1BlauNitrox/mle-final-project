...
| 2026-08-21 | Review fixes for the experiment metric pipeline in issue #25: learning-metric transport, observed-agent isolation, configuration fingerprinting, step semantics, coin-efficiency aggregation, tests, and documentation | OpenAI Codex | Team must inspect the callback contract and metric definitions, verify the fingerprint and multi-agent behavior, run the full validation suite, and obtain peer approval before merge. |
