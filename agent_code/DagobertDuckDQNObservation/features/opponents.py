...
def opponent_features(
    *,
    ...
    attack_opportunity = int(any(candidate in footprint for candidate in opponent_positions))
    ...
    adjacency = tuple(int((x + dx, y + dy) in opponent_positions) for dx, dy in DIRECTIONS)
