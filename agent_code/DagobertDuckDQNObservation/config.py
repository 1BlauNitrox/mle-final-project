"""Central configuration for the DQN Task 3 successor.
...
REWARDS: dict[str, float] = {
    ...
    # Task 3 addition. The framework emits one event for each opponent
    # eliminated by this agent's bomb; OPPONENT_ELIMINATED remains diagnostic.
    "KILLED_OPPONENT": 5.0,
}
...
class DQNConfig:
    ...
    def __post_init__(self) -> None:
        ...
        if self.observation_mode not in {"control", "geometry", "memory"}:
