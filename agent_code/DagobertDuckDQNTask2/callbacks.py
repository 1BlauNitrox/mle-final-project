...
def setup(self) -> None:
    """Load the behavior-preserving evaluation network.

    There is no resumable training state in this structural successor.
    ``train.py`` rejects training after setup, while this callback remains
    able to load the evaluation-only parent artifact in either framework mode.
    """
