"""Evaluation-only artifact handling for the Task 2 successor scaffold.

Issue #43 deliberately preserves the frozen Task 1 policy and keeps training
disabled. Its copied artifact therefore remains evaluation-only: resumable
training state is introduced only by the separately reviewed Task 2
capability work in issue #44.
"""
