...
from scripts.analyze_task3_frozen import behavioral, interval  # noqa: E402
from scripts.frozen_opponent_inputs import FrozenOpponentInputs, validate_frozen  # noqa: E402
from scripts.pilot_task3_frozen import config, episode_epsilon  # noqa: E402
...
def test_full_synthetic_pilot_preserves_negative_retention_and_host_gates(tmp_path, monkeypatch):
    import scripts.analyze_task3_frozen as analysis
    from scripts.pilot_task3_frozen import sha, write, zip_json
    ...
    import scripts.pilot_task3_frozen as pilot
