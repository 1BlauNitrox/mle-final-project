    ...
    *,
    ...
    return {
        ...
        **action_counts,
        ...
        "total_state_visits": _optional_non_negative_int(
            learning_metrics.get("total_state_visits"),
            field="total_state_visits",
            round_number=round_number,
            agent_name=agent_name,
        ),
        "mean_visits_per_state": _optional_number(
            learning_metrics.get("mean_visits_per_state"),
            field="mean_visits_per_state",
            round_number=round_number,
            agent_name=agent_name,
        ),
        "singleton_state_fraction": _optional_number(
            learning_metrics.get("singleton_state_fraction"),
            field="singleton_state_fraction",
            round_number=round_number,
            agent_name=agent_name,
        ),
        "evaluation_decisions": _optional_non_negative_int(
            learning_metrics.get("evaluation_decisions"),
            field="evaluation_decisions",
            round_number=round_number,
            agent_name=agent_name,
        ),
        "evaluation_unseen_decisions": _optional_non_negative_int(
            learning_metrics.get("evaluation_unseen_decisions"),
            field="evaluation_unseen_decisions",
            round_number=round_number,
            agent_name=agent_name,
        ),
        "evaluation_unseen_state_rate": _optional_number(
            learning_metrics.get("evaluation_unseen_state_rate"),
            field="evaluation_unseen_state_rate",
            round_number=round_number,
            agent_name=agent_name,
        ),
