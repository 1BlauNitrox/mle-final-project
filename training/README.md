...
Staged plans may set `replay_treatment: uniform` or
...
| `replay_treatment` | string | `uniform` | Task-2 DQN replay selector: `uniform` or `protected_task1`; recorded in every job and protected by the plan fingerprint. |
