...
def seeded_event_wrapper(original, root_seed):
    ...
    def process_event(self, event_name, *event_args):
        ...
        if not hasattr(self, "_issue221_rng"):
        ...
        try:
            ...
            self._issue221_rng = np.random.get_state(), random.getstate()
