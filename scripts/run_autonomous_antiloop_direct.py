"""Bind the direct original-policy versus broad-guard comparison."""
...
CONFIG = ROOT / "experiments/2026-09-20-autonomous-antiloop-direct/config.json"
...
def sources():
    ...
    paths += [
        ROOT / "scripts" / name
        for name in (
            "run_autonomous_antiloop_direct.py",
            "run_autonomous_antiloop.py",
            "analyze_autonomous_antiloop.py",
            "audit_autonomous_antiloop_direct_seeds.py",
