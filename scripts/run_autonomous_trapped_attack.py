"""Bind the trapped-opponent attack comparison to its registration."""
...
CONFIG = ROOT / "experiments/2026-09-21-autonomous-trapped-attack/config.json"
...
def sources():
    ...
    paths += [
        ROOT / "scripts" / name
        for name in (
            "run_autonomous_trapped_attack.py",
            "run_autonomous_antiloop.py",
            "analyze_autonomous_antiloop.py",
            "audit_autonomous_trapped_attack_seeds.py",
