"""Bind the post-loop safe-attack pilot to its registration."""
...
CONFIG = ROOT / "experiments/2026-09-20-autonomous-safe-attack/config.json"
...
def sources():
    ...
    paths += [
        ROOT / "scripts" / name
        for name in (
            "run_autonomous_safe_attack.py",
            "run_autonomous_antiloop.py",
            "analyze_autonomous_antiloop.py",
            "audit_autonomous_safe_attack_seeds.py",
