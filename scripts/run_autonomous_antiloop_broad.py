"""Bind the broad 16-step anti-loop comparison to its registration."""
...
CONFIG = ROOT / "experiments/2026-09-20-autonomous-antiloop-broad/config.json"
...
def sources():
    ...
    paths += [
        ROOT / "scripts" / name
        for name in (
            "run_autonomous_antiloop_broad.py",
            "run_autonomous_antiloop.py",
            "analyze_autonomous_antiloop.py",
            "audit_autonomous_antiloop_broad_seeds.py",
