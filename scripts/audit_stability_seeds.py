"""Opaque collision audit for every Issue #213 seed and derived opponent offset."""
...
EXPERIMENT = ROOT / "experiments/2026-09-19-continuation-stability"
OWN = "experiments/2026-09-19-continuation-stability/"
...
def candidates(config):
    values = {config["smoke_seed"], config["bootstrap_seed"], *config["learner_seeds"]}
    for pair in config["train_ranges"]:
        values |= inclusive(pair)
    for suite in config["evaluation"].values():
