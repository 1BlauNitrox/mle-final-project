"""Opaque collision audit for the autonomous Issue #225 anti-loop campaign."""
...
EXPERIMENT = ROOT / "experiments/2026-09-20-autonomous-antiloop-campaign"
OWN = "experiments/2026-09-20-autonomous-antiloop-campaign/"
...
def candidates(config):
    values = {config["bootstrap_seed"], config["evaluation_agent_seed"], config["smoke_seed"]}
