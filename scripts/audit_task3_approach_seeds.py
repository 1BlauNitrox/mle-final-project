...
from scripts.pilot_task3_approach import PROFILES, ROOT, write
...
def main():
    ...
    parser.add_argument("--profile", choices=PROFILES, default=os.environ.get(
        "TASK3_APPROACH_PROFILE", PROFILES[0]
    ))
    args = parser.parse_args()
    result = audit(args.profile)
    write(ROOT / f"experiments/2026-09-14-task3-{args.profile}/seed-audit.json", result)
