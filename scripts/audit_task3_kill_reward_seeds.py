...
from scripts.pilot_task3_kill_reward import ROOT, config, write
...
def audit():
    ...
    refs = [r for r in refs if not r.endswith("/HEAD") and "/175-" not in r]
    objects = {}
    revisions = {}
    for ref in refs:
...
if __name__ == "__main__":
    output = ROOT / "experiments/2026-09-14-task3-elimination-reward/seed-audit.json"
    result = audit()
    write(output, result)
