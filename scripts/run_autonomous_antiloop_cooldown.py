"""Bind iteration 2 to its registration and delegate to the verified runner."""
...
CONFIG = ROOT / "experiments/2026-09-20-autonomous-antiloop-cooldown/config.json"
...
def sources():
    ...
    paths += [
        ROOT / "scripts" / name
        for name in (
            "run_autonomous_antiloop_cooldown.py",
            "run_autonomous_antiloop.py",
            "analyze_autonomous_antiloop.py",
            "audit_autonomous_antiloop_cooldown_seeds.py",
