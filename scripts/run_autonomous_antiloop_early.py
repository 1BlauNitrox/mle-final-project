"""Bind iteration 4 to its registration and delegate to the verified runner."""
...
CONFIG = ROOT / "experiments/2026-09-20-autonomous-antiloop-early/config.json"
...
def sources():
    ...
    paths += [
        ROOT / "scripts" / name
        for name in (
            "run_autonomous_antiloop_early.py",
            "run_autonomous_antiloop.py",
            "analyze_autonomous_antiloop.py",
            "audit_autonomous_antiloop_early_seeds.py",
