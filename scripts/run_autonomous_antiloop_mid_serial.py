"""Bind the one-worker iteration-5 rerun to its registration."""
...
CONFIG = ROOT / "experiments/2026-09-20-autonomous-antiloop-mid-serial/config.json"
...
def sources():
    ...
    paths += [
        ROOT / "scripts" / name
        for name in (
            "run_autonomous_antiloop_mid_serial.py",
            "run_autonomous_antiloop.py",
            "analyze_autonomous_antiloop.py",
            "audit_autonomous_antiloop_mid_serial_seeds.py",
