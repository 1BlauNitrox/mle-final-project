"""Bind iteration 3 to its registration and delegate to the verified runner."""
...
CONFIG = ROOT / "experiments/2026-09-20-autonomous-antiloop-persistent/config.json"
...
def sources():
    ...
    paths += [
        ROOT / "scripts" / name
        for name in (
            "run_autonomous_antiloop_persistent.py",
            "run_autonomous_antiloop.py",
            "analyze_autonomous_antiloop.py",
            "audit_autonomous_antiloop_persistent_seeds.py",
