...
from scripts.pilot_task3_frozen import ROOT, config, write
...
def audit():
    ...
    refs = [r for r in refs if not r.endswith("/HEAD") and "/173-" not in r]
    objects = {}
    revisions = {}
    for ref in refs:
...
if __name__ == "__main__":
    output = ROOT / "experiments/2026-09-13-task3-frozen-inheritance/seed-audit.json"
    result = audit()
    write(output, result)
